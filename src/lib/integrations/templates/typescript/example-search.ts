...
import { createWeaviateClient, createDocumentSchema, addDocument, searchDocuments } from './weaviate-client';
 ...
 * Next steps:
 * 
 * 1. Replace the default configuration in weaviate-client.ts with your Weaviate cluster details
 * 2. Install the Weaviate client: npm install weaviate-ts-client
 * 3. Run this example: ts-node example-search.ts (or transpile to JavaScript first)
 * 
